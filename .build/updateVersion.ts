...
const manifestFilePath = join(__dirname, '../custom_components/harvest_time_tracker/manifest.json');
const constantFilePath = join(__dirname, '../custom_components/harvest_time_tracker/const.py');
